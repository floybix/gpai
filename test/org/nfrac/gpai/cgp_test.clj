(ns org.nfrac.gpai.cgp-test
  (:use clojure.test)
  (:require (org.nfrac.gpai [cgp :refer :all]
                            [cgp-viz :as cgp-viz]
                            [lang-float :as langf])))
...
(def gm1
  '{:inputs ["a" "b" "c"],
    :nodes [{}
            ...
            {:fn org.nfrac.gpai.lang-float/_mod_, :in [4 2]}
            {:fn nil, :in [], :value 5.79469347837637}
            {:fn org.nfrac.gpai.lang-float/_-_, :in [1 0]}
            {:fn org.nfrac.gpai.lang-float/_mod_, :in [3 5]}
            {:fn nil, :in [], :value 5.035921772704431}
            {:fn org.nfrac.gpai.lang-float/_-_, :in [2 2]}
            {:fn org.nfrac.gpai.lang-float/_-_, :in [3 5]}
            {:fn org.nfrac.gpai.lang-float/_-_, :in [7 6]}
            {:fn org.nfrac.gpai.lang-float/_div_, :in [2 4]}
            {:fn org.nfrac.gpai.lang-float/_-_, :in [10 10]}
            {:fn org.nfrac.gpai.lang-float/_+_, :in [6 13]}],
    :out-ids [14 15]})
