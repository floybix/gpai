...
(deftest lang-integer-test
  ...
  (testing "Control functions."
    (is (= 1 (i/_if<_ 2 3 1 -1)) "If< true branch")
    (is (= -1 (i/_if<_ 3 2 1 -1)) "If< false branch")
    (is (= -1 (i/_if<_ 2 2 1 -1)) "If< strict comparison")))
...
(deftest lang-float-test
  ...
  (testing "Control functions."
    (is (= 1.0 (f/_if<_ 2.2 3.3 1.0 -1.0)) "If< true branch")
    (is (= -1.0 (f/_if<_ 3.3 2.2 1.0 -1.0)) "If< false branch")
    (is (= -1.0 (f/_if<_ 2.2 2.2 1.0 -1.0)) "If< strict comparison")))
